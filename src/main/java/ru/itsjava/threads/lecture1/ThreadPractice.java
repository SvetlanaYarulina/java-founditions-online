...
//        System.out.println("end");
        ...
        PrinterThread printerThread1 = new PrinterThread("1", 3000L);

        PrinterRunnable printerRunnable = new PrinterRunnable("Добро пожаловать в Java!", 5000L);
        Thread thread2 = new Thread(printerRunnable);
